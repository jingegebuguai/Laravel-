...
<!--头部 开始-->
	<div class="top_box">
		...
		<div class="top_right">
			<ul>
				...
				<li><a href="{{url('admins/pass')}}" target="main">修改密码</a></li>
				<li><a href="{{url('admins/login')}}">退出</a></li>
			</ul>
		</div>
	</div>
	<!--头部 结束-->
	...
	<!--主体部分 开始-->
	<div class="main_box">
		<iframe src="{{url('admins/info')}}" frameborder="0" width="100%" height="100%" name="main"></iframe>
	</div>
	<!--主体部分 结束-->
